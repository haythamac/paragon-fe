...
const placeholderParticipants = [
    ...
    { id: 7, name: 'Liam Johnson', class: 'Berserker', level: 70, growthPower: 13456 },
    { id: 8, name: 'Sophia Lee', class: 'Druid', level: 48, growthPower: 7450 },
    { id: 9, name: 'Noah Brown', class: 'Necromancer', level: 53, growthPower: 8123 },
    { id: 10, name: 'Olivia Davis', class: 'Monk', level: 60, growthPower: 6789 },
]
    ...
    <div class="bg-[#0b0b0d] border border-gray-800 rounded-lg p-4">
        ...
        <div v-if="filteredParticipants.length > 0" class="grid grid-cols-1 md:grid-cols-3 gap-2.5 mb-3">
            <div v-for="participant in filteredParticipants" :key="participant.id"
                ...
                <h3 class="text-sm font-semibold text-white mb-1.5">{{ participant.name }}</h3>
